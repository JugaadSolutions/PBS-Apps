            ...
            public void run() {
                try {
                    ...
                    if(loginpref.contains("User-id"))
                    {
                        ...
                        if(!loginuserid.equals(null)&&role.equals("registration-employee"))
                        {
                            startActivity(new Intent(Splash.this, GetStarted.class));
                        }
                        else if(!loginuserid.equals(null)&&role.equals("redistribution-employee"))
                        {
                            startActivity(new Intent(Splash.this, Redistribution.class));
                        }
                        else if(!loginuserid.equals(null)&&role.equals("maintenancecentre-employee"))
                        {
                            startActivity(new Intent(Splash.this, GetStarted_MC.class));
                        }
                        else
                        {
