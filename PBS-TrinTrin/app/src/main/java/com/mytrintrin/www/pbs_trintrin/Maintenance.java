...
public class Maintenance extends AppCompatActivity {
    ...
    JSONObject Maintenanceobject,Chekcboxobject;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaintenanceToolbar = (Toolbar) findViewById(R.id.maintenancetoolbar);
        MaintenanceToolbar.setTitle("Maintenance");
        setSupportActionBar(MaintenanceToolbar);
    ...
    private void getalldockingstations() {
        ...
        StringRequest alldockingstationrequest = new StringRequest(Request.Method.GET, API.alldockingstation, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (i = 0; i < data.length(); i++) {
                        ...
                        Stationnameadapter = new ArrayAdapter<String>(Maintenance.this, android.R.layout.simple_spinner_dropdown_item, StationnameArrayList);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof ServerError) {
                    Toast.makeText(Maintenance.this, "Server is under maintenance.please try later.", Toast.LENGTH_LONG).show();
                    Log.d("Error", String.valueOf(error instanceof ServerError));
                    error.printStackTrace();
                } else if (error instanceof AuthFailureError) {
                    Toast.makeText(Maintenance.this, "Authentication Error", Toast.LENGTH_LONG).show();
                    Log.d("Error", "Authentication Error");
                    error.printStackTrace();
                } else if (error instanceof ParseError) {
                    Toast.makeText(Maintenance.this, "Parse Error", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(Maintenance.this, "Timeout Error", Toast.LENGTH_LONG).show();
                    Log.d("Error", "Timeout Error");
                    error.printStackTrace();
                } else if (error instanceof NoConnectionError) {
                    Toast.makeText(Maintenance.this, "No Connection Error", Toast.LENGTH_LONG).show();
                    Log.d("Error", "No Connection Error");
                    error.printStackTrace();
                } else {
                    Toast.makeText(Maintenance.this, "Something went wrong", Toast.LENGTH_LONG).show();
                    error.printStackTrace();
                }
            }
        }) {
        ...
        alldockingstationrequest.setRetryPolicy(new DefaultRetryPolicy(25000, DefaultRetryPolicy.DEFAULT_MAX_RETRIES, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0;i<data.length();i++)
                    {
                        ...
                        McEmpnameadapter = new ArrayAdapter<String>(Maintenance.this, android.R.layout.simple_spinner_dropdown_item, McEmpnameArrayList);
    ...
    public void getmaintaincechecklist()
    {
        StringRequest maintainencechecklistrequest = new StringRequest(Request.Method.GET, API.maintaincechecklist, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    JSONObject responsefromserver = new JSONObject(response);
    ...
    public void submitdetails(View view)
    {
        ...
        Maintenanceobject = new JSONObject();
        ...
        try {
            Maintenanceobject.put("employeeId", empid);
            Maintenanceobject.put("vehicleId", CycleNumber);
            Maintenanceobject.put("location", stationid);
            Maintenanceobject.put("createdBy", loginuserid);
            Maintenanceobject.put("checkList", Checklistarray);
            Maintenanceobject.put("origin","app");
        } catch (JSONException e) {
            e.printStackTrace();
        }

        JsonObjectRequest maintenancerequest = new JsonObjectRequest(Request.Method.POST, API.maintainedcycleinDS,Maintenanceobject, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Toast.makeText(Maintenance.this, "Details updated succesfully", Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof ServerError) {
                    Toast.makeText(Maintenance.this, "Server Error", Toast.LENGTH_LONG).show();
                    Log.d("Error", String.valueOf(error instanceof ServerError));
                    error.printStackTrace();
                } else if (error instanceof AuthFailureError) {
                    Toast.makeText(Maintenance.this, "Authentication Error", Toast.LENGTH_LONG).show();
    ...
    public void createchecklist() {
        try {
            ...
            for (int i=0 ;i<value.length();i++)
            {
                ...
                AppCompatCheckBox air = new AppCompatCheckBox(Maintenance.this);
                air.setId(i);
