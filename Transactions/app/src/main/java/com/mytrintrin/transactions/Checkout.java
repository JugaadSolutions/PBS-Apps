            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    ...
                    case 1:
                        ...
                        Fleetadapter = new ArrayAdapter<String>(Checkout.this, android.R.layout.simple_spinner_dropdown_item, Splash.FleetNameArrayList);
                    ...
                    case 2:
                        ...
                        HAadapter = new ArrayAdapter<String>(Checkout.this, android.R.layout.simple_spinner_dropdown_item, Splash.HANameArrayList);
                    ...
                    case 3:
                       ...
                       // checkoutPortid=TransactionAPI.redistrubutionid;
                        ...
                        RVadapter = new ArrayAdapter<String>(Checkout.this, android.R.layout.simple_spinner_dropdown_item, Splash.RVNameArrayList);
                    ...
                    case 4:
                        ...
                        MCadapter = new ArrayAdapter<String>(Checkout.this, android.R.layout.simple_spinner_dropdown_item, Splash.MCNameArrayList);
    ...
    public void sendcheckoutdetails(View view)
    {
        ...
        StringRequest checkoutrequest = new StringRequest(Request.Method.POST, TransactionAPI.checkouturl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                coVehicleID.setText("");
                coCardID.setText("");
                Toast.makeText(Checkout.this,"Check out Successfully",Toast.LENGTH_LONG).show();
            }
