...
public class Splash extends AppCompatActivity {
    ...
    public  void getFleetdetails()
    {
        ...
        Singleton.getInstance(this).addtorequest(fleetrequest);
    }
    ...
    public  void getRestributiondetails()
    {
        ...
        Singleton.getInstance(this).addtorequest(restributionrequest);
    }
    ...
    public void getMCdetails()
    {
        ...
        Singleton.getInstance(this).addtorequest(maintenancerequest);
    }
...

    {
        ...
        Singleton.getInstance(this).addtorequest(holdingarearequest);
    }
